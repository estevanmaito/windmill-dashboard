...
<main class="h-full pb-16 overflow-y-auto">
  <div class="container grid px-6 mx-auto">
    ...
    <div class="flex flex-col justify-between flex-wrap mb-4 space-y-4 md:flex-row md:items-end md:space-x-4">
      ...
      <a href="index1.php?action=createItem"><button
      ...
      <div class="w-full overflow-x-auto">
        ...
        <div class="w-full whitespace-no-wrap container mx-auto ">
          ...
          <div class="table-header-group">
            <!-- row -->
            <div
              class="table-row flex text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b dark:border-gray-700 bg-gray-50 dark:text-gray-400 dark:bg-gray-800">
              <!-- columns -->
              <div
                class="table-cell px-4 py-3 p-2 text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b border-gray-500 dark:border-gray-700"
                style="width: 16.6667%;flex-grow:0!important">NOM</div>
              <div
                class="table-cell px-4 py-3 p-2 text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b border-gray-500 dark:border-gray-700"
                style="width: 16.6667%;">TYPE</div>
              <div
                class="table-cell px-4 py-3 p-2 text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b border-gray-500 dark:border-gray-700"
                style="width: 16.6667%;"> EMPLACEMENT </div>
              <div
                class="table-cell px-4 py-3 p-2 text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b border-gray-500 dark:border-gray-700"
                style="width: 16.6667%;"> EMPLACEMENT DE L'ARTICLE </div>
              <div
                class="table-cell px-4 py-3 p-2 text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b border-gray-500 dark:border-gray-700"
                style="width: 16.6667%;"> DESCRIPTION </div>
              <div
                class="table-cell px-4 py-3 p-2 text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b border-gray-500 dark:border-gray-700"
                style="width: 16.6667%;">PROPRIÉTAIRE</div>
              <div
                class="table-cell px-4 py-3 p-2 text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b border-gray-500 dark:border-gray-700"
                style="width: 16.6667%;"> PRIX </div>
              <div
                class="table-cell px-4 py-3 p-2 text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b border-gray-500 dark:border-gray-700"
                style="width: 16.6667%;">UNITÉ </div>
              <div
                class="table-cell px-4 py-3 p-2 text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b border-gray-500 dark:border-gray-700"
                style="width: 16.6667%;">SATUT </div>
              <div
                class="table-cell px-4 py-3 p-2 text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b border-gray-500 dark:border-gray-700"
                style="width: 16.6667%;">ACTION </div>
            </div>
          </div>
          <!-- Table rows -->
          ...
          if (is_array($data) || is_object($data)) {
            foreach ($data as $item): ?>
              ...
              <div class="item-row table-row-group " data-id="<?php echo $item->getItemId() ?>">
                <div
                  class=" table-row flex bg-gray-50 dark:bg-gray-900 text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-800 dark:text-gray-400 h-12"
                  ...
                  <div class="table-cell px-4 py-3 p-2 text-sm" style="width: 16.6667%;">
                    <div class="flex  items-center space-x-4 text-sm">
                      <div class="relative ">
                        <button class="dropdownbtton" type="button" onclick="toggleDropdown(this)"
                          data-item-id="<?php echo $item->getItemId() ?>">
                          <svg class="dropdownbtton" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                        ...
                        <!-- Dropdown menu -->
                        <div id="dropdownDelay-<?php echo $item->getItemId() ?>"
                          class="drop absolute z-20 right-0 w-56 space-y-2 hidden text-gray-600 bg-white border border-gray-100 rounded-md shadow-md dark:text-gray-300 dark:border-gray-700 dark:bg-gray-700">
                          <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDelayButton">
                            <li><a href="index1.php?action=editItem&id=<?php echo $item->getItemId() ?>"
                                class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-white">Modifier</a>
                            </li>
                            <li><a href="index1.php?action=reserveItem"
                                class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-white">Réserver</a>
                            </li>
                            <li><a onclick="return confirm('voulez vous vraiment supprimer ce utilisateur')"
                                href="index1.php?action=destroyItem&id=<?php echo $item->getItemId() ?>"
                                class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-white">Supprimer</a>
                            </li>
                          </ul>
                        </div>
                      </div>
